...
from screen import *
from CalculAnneauGlacial import UpStats
...
def MainAnneauGlacial():
    carac_position = [0.2, 1.0, 3.0, 10.0, 5.0, 3.0, 4.0, 2.0]
    X, count, done, w = 0, 0, False, 0
